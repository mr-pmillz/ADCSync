...
def retrieve_certificates(accounts, user, password, dc_ip, dc_fqdn, ca_name, target, template, proxychains, dns_tcp, dns, name_server, timeout, ldap_channel_binding, debug, threads):
...
def authenticate_accounts(accounts, dc_ip, proxychains, output_file, dns_tcp, name_server, timeout, threads):
...
def main(file, output, ca_name, dc_ip, dc_fqdn, user, password, template, target, dns_tcp, dns, name_server, timeout, ldap_channel_binding, debug, proxychains, threads):
    ...
    retrieve_certificates(accounts, user, password, dc_ip, dc_fqdn, ca_name, target, template, proxychains, dns_tcp, dns, name_server, timeout, ldap_channel_binding, debug, threads)

    authenticate_accounts(accounts, dc_ip, proxychains, output, dns_tcp, name_server, timeout, threads)
